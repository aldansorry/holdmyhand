	...
	<div class="container-fluid">
		...
		<div class="row" id="news-form-container">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Data News <a href="<?php echo base_url('Admin/News/input') ?>" class="btn btn-rounded btn-primary float-right">Input</a></h4>

						<div class="table-responsive m-t-40">
							<table id="news-table" class="display nowrap table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>#</th>
										<th>Title</th>
	...
	$(document).ready(() => {
		$('#news-table').DataTable( {
			...
			},
			{
				...
				render: (data, type, row) => {
					let ret = "";
					ret += ' <a href="<?php echo base_url("Admin/News/update/") ?>'+data+'" class="btn btn-sm btn-rounded btn-success"> <i class="fa fa-pencil"></i> Edit</a>';
